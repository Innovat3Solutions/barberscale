  ...
  return (
    <section id="pricing" style={{ padding: '8rem 0', position: 'relative', textAlign: 'center', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <h2 style={{ fontSize: '3.5rem', marginBottom: '1.5rem', textTransform: 'uppercase', textShadow: '0 4px 15px rgba(0,0,0,0.8)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginTop: '3rem' }}>
          {/* Starter Tier */}
          <div className="data-frame" style={{ padding: '2.5rem 2rem', backdropFilter: 'blur(10px)', background: 'rgba(26, 26, 26, 0.4)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ fontSize: '3.5rem', fontFamily: 'var(--font-heading)', color: 'var(--neon-green)', marginBottom: '0.5rem', lineHeight: '1', textShadow: '0 0 20px rgba(0,255,65,0.3)' }}>
          ...
          {/* Growth Tier */}
          <div className="data-frame" style={{ position: 'relative', padding: '2.5rem 2rem', backdropFilter: 'blur(10px)', background: 'rgba(0, 255, 65, 0.05)', display: 'flex', flexDirection: 'column', border: '1px solid rgba(0,255,65,0.3)', transform: 'scale(1.05)', zIndex: 2, boxShadow: '0 0 30px rgba(0,255,65,0.1)' }}>
            <div style={{ position: 'absolute', top: '-12px', left: '50%', transform: 'translateX(-50%)', background: 'var(--neon-green)', color: '#000', padding: '0.2rem 1rem', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 'bold', textTransform: 'uppercase' }}>Most Popular</div>
